...
{
	KexLogWarningEvent(L"Unimplemented WinHttpCreateProxyResolver function called");
	KexDebugCheckpoint();
...
{
	KexLogWarningEvent(L"Unimplemented WinHttpGetProxyForUrlEx function called");
	KexDebugCheckpoint();
...
{
	KexLogWarningEvent(L"Unimplemented WinHttpGetProxyResult function called");
	KexDebugCheckpoint();
...
{
	KexLogWarningEvent(L"Unimplemented WinHttpFreeProxyResult function called");
	KexDebugCheckpoint();
}
...
KXNETAPI DWORD WINAPI WinHttpWebSocketClose(
	...
	IN DWORD len)
{
	KexLogWarningEvent(L"Unimplemented WinHttpWebSocketClose function called");
	return ERROR_WINHTTP_UNABLE_TO_DOWNLOAD_SCRIPT;
}
...
{
	KexLogWarningEvent(L"Unimplemented WinHttpWebSocketReceive function called");
	return ERROR_WINHTTP_UNABLE_TO_DOWNLOAD_SCRIPT;
}
...
KXNETAPI DWORD WINAPI WinHttpWebSocketSend(
	...
	IN DWORD dwBufferLength)
{
	KexLogWarningEvent(L"Unimplemented WinHttpWebSocketSend function called");
	return ERROR_WINHTTP_UNABLE_TO_DOWNLOAD_SCRIPT;
}
...
{
	KexLogWarningEvent(L"Unimplemented WinHttpWebSocketCompleteUpgrade function called");
	return ERROR_WINHTTP_UNABLE_TO_DOWNLOAD_SCRIPT;
}
...
{
	KexLogWarningEvent(L"Unimplemented WinHttpWebSocketShutdown function called");
	return ERROR_WINHTTP_UNABLE_TO_DOWNLOAD_SCRIPT;
}