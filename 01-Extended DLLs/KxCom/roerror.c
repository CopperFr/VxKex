...
KXCOMAPI VOID RoFailFastWithErrorContext(
	IN	HRESULT hrError)
{
	KexLogWarningEvent(L"Unimplemented function RoFailFastWithErrorContext called.");
}

KXCOMAPI HRESULT RoGetMatchingRestrictedErrorInfo(
	HRESULT					hrIn,
	IRestrictedErrorInfo** ppRestrictedErrorInfo)
{
	KexLogWarningEvent(L"Unimplemented function RoGetMatchingRestrictedErrorInfo called.");
	return STATUS_NOT_IMPLEMENTED;
}

KXCOMAPI HRESULT RoReportFailedDelegate(
	IN	IUnknown* punkDelegate,
	IN	IRestrictedErrorInfo* pRestrictedErrorInfo)
{
	KexLogWarningEvent(L"Unimplemented function RoReportFailedDelegate called.");
	return STATUS_NOT_IMPLEMENTED;
}

KXCOMAPI BOOL IsErrorPropagationEnabled()
{
	return FALSE;
}