...
STATIC CONST UNICODE_STRING DllRedirects[][2] = {
	...
	DLL_REDIRECT("uiautomationcore",							"kxuiacore"			)
	DLL_REDIRECT("coremessaging",								"kxcom"				)

	//DLL_REDIRECT("profapi",										"profa10"			) // missing 114 ordinal
	...
	DLL_REDIRECT("api-ms-win-core-string",						"kxuser"			) // kxbase => kxuser
	DLL_REDIRECT("api-ms-win-core-string-obsolete",				"kxbase"			)
	...
	DLL_REDIRECT("api-ms-win-ro-typeresolution",				"wintypes"			) // kxcom
	...
	DLL_REDIRECT("api-ms-win-security-provider",				"kxadvapi"			)
	...
	DLL_REDIRECT("ext-ms-win-uiacore",							"kxuiacore"			)
