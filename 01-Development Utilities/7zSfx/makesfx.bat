...
REM copy ..\..\%DBGREL%\CpiwBypa.dll Archive\Core32\ >nul
...
copy ..\..\%DBGREL%\KxUiaCore.dll Archive\Kex32\ >nul
...
REM copy ..\..\x64\%DBGREL%\CpiwBypa.dll Archive\Core64\ >nul
...
copy ..\..\x64\%DBGREL%\KxUiaCore.dll Archive\Kex64\ >nul
...
REM	copy ..\..\%DBGREL%\CpiwBypa.pdb Archive\Core32\ >nul
	copy ..\..\%DBGREL%\VxKexLdr.pdb Archive\Core32\ >nul

	copy ..\..\%DBGREL%\KxAdvapi.pdb Archive\Kex32\ >nul
	copy ..\..\%DBGREL%\KxAutomationCore.pdb Archive\Kex32\ >nul
...
REM	copy ..\..\x64\%DBGREL%\CpiwBypa.pdb Archive\Core64\ >nul
	copy ..\..\x64\%DBGREL%\VxKexLdr.pdb Archive\Core64\ >nul

	copy ..\..\x64\%DBGREL%\KxAdvapi.pdb Archive\Kex64\ >nul
	copy ..\..\x64\%DBGREL%\KxAutomationCore.pdb Archive\Kex64\ >nul
